...
export const VISION_LEAD_COPY =
  "A new vision of music TV\nfor the streaming era.";
export const VISION_LAUNCH_COPY = "Launching late 2026.";
export const VISION_FULL_TEXT = `${VISION_LEAD_COPY}${VISION_LAUNCH_COPY}`;
export const LANDING_DISCLAIMER =
  "This preview is intended for discussion purposes. All audiovisual works remain the property of their respective rights holders.";
